...
<head>
	...
	<link href="/path/to/public/css/tailwind.css" rel="stylesheet">
...
<body>
	...
	<div
		class="bg-[url('assets/img/degradado.jpg')] bg-center absolute top-0 left-0 bottom-0 leading-5 h-full w-full overflow-hidden">
	...
	<div class="relative min-h-screen  sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
		<div class="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
			<div class="self-start hidden lg:flex flex-col text-gray-300">
				...
				<h1 class="my-3 font-semibold text-4xl">Bienvenido Nuevamente</h1>
				<p class="pr-3 text-sm opacity-75">Ingresa tus datos y empieza a usar la app.</p>
			</div>
		</div>
		<div class="flex justify-center self-center  z-10">
			<div class="p-12 bg-white shadow-xl mx-auto rounded-3xl w-96 ">
				<div class="mb-7">
					<h3 class="font-semibold text-center text-3xl text-gray-800">Iniciar Sesion</h3>
				</div>
				<?php if (!empty($this->messages)): ?>
					<div class="my-2 p-2 text-center rounded-[5px] bg-gray-300 animate-pulse">
				...
				<form action="<?php echo constant('URL'); ?>/signup/newUser" method="POST" class="space-y-6">
					...
					<div class="flex items-center justify-between">
						...
						<div class="text-sm ml-auto">
							<a href="#" class="text-azul hover:text-purple-600">
					...
					<div>
						<button type="submit"
							class="w-full flex justify-center bg-azul  hover:bg-azul_oscuro text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">
							Entrar
						</button>
					</div>
