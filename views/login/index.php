	...
	<div class="relative sm:flex sm:flex-row justify-center min-h-[100vh] p-16 rounded-3xl shadow-xl">
		...
		<div class="flex justify-center self-center z-10">
			<div class="p-12 bg-white shadow-xl rounded-3xl w-96">
				<div class="mb-5">
					<h3 class="font-semibold text-center text-3xl text-gray-800">Iniciar Sesión</h3>
				...
				<?php if ($this->hasMessages()): ?>
					<div class="notificacion">
						<div class="notificacion_body">
							...
							<i class="fa-solid fa-circle-xmark" style="color: #df0707;"></i>
						</div>
				...
				<form action="<?php echo constant('URL'); ?>/signup/newUser" method="POST" class="space-y-6">
					<div>
						<input
							...
							type="text" name="usuario" placeholder="Email">
					</div>
					<div class="relative" x-data="{ show: true }">
						<input name="contraseña" placeholder="Contraseña" :type="show ? 'password' : 'text'"
					...
					<div class="flex flex-col gap-2">
						...
						<button type="submit"
							class="w-full flex justify-center bg-[#615EFC] hover:bg-[#1A2130] text-gray-100 p-3 rounded-lg tracking-wide font-semibold cursor-pointer transition ease-in duration-500">Entrar</button>

						<a href="signup"
							class="w-full flex justify-center bg-transparent hover:bg-[#1A2130] hover:text-white text-[#1A2130] p-3 rounded-lg tracking-wide font-semibold cursor-pointer transition ease-in duration-500">Crear
							Cuenta</a>
