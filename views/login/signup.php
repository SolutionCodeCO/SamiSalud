...
<div
	class="relative sm:flex sm:flex-row justify-center min-h-[100vh] p-16 rounded-3xl shadow-xl">
	...
	<div class="flex justify-center self-center z-10">
		<div class="p-12 bg-white shadow-xl rounded-3xl w-96 ">
			<div class="mb-5">
				<h3 class="font-semibold text-center text-3xl text-gray-800">Bienvenido</h3>
                <p class="text-[13px] text-center">Llena los campos para obtener un registro éxitoso.</p>
			</div>
			<form action="<?php echo constant('URL'); ?>/signup/newUser" method="POST" class="space-y-6">
				<div class="">
					<input class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-azul text-azul_oscuro" type="" placeholder="Email">
              </div>


					<div class="relative" x-data="{ show: true }">
						<input placeholder="Contraseña" :type="show ? 'password' : 'text'" class="text-sm text-azul_oscuro px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
					...
					<div class="flex items-center justify-between">
						...
						<div class="text-sm ml-auto">
							<a href="#" class="text-azul hover:text-blue-600">
								¿Olvidaste tu Contraseña?
							</a>
						</div>
					</div>
					<div>
					<button type="submit" class="w-full flex justify-center bg-[#615EFC]  hover:bg-[#1A2130] text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">
                    Entrar
                    </button>
					</div>
